...
flowchart LR
    ...
    Router -->|Blue Cable| PublicCable1
    Router -->|Blue Cable| PublicCable2
    Router -->|Blue Cable| PublicCable3
    Router -->|Blue Cable| PublicCable4

    %% Private Interconnect Connections (Green Cables)
    PrivateCable1 -->|Green Cable| Switch1
    PrivateCable2 -->|Green Cable| Switch1
    PrivateCable3 -->|Green Cable| Switch1

    %% iSCSI Storage Connections (Red Cables)
    StorageCable1 -->|Red Cable| Switch2
    StorageCable2 -->|Red Cable| Switch2
    StorageCable3 -->|Red Cable| Switch2
    StorageCable4 -->|Red Cable| Switch2

    %% =========================================================================
    %% 5. LINK STYLING DIRECTIVES
    %% =========================================================================
    linkStyle 0,1,2,3 stroke:#0066cc,stroke-width:2px,fill:none;
    linkStyle 4,5,6 stroke:#009933,stroke-width:2px,fill:none;
    linkStyle 7,8,9,10 stroke:#cc0000,stroke-width:2px,fill:none;
```
### (Mermaid version)
```mermaid
  info
